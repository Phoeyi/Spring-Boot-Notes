...
public class CustomerServiceImpl implements CustomerService {
	 ...
	 */
	@Override
	public ResponseTemplate<CustomerResponse> queryCustomer(RequestTemplate<CustomerRequest> req)
...
//		customerInnerData.setSex(customerEntity.getSex());
		...
		// ObjectMapper：entity -> customerResponse
		ObjectMapper objectMapper = new ObjectMapper();
		objectMapper.convertValue(customerEntity, CustomerResponse.Data.class);
	 ...
	 */
	@Override
	public ResponseTemplate<CustomerResponse> insertCustomer(RequestTemplate<CustomerRequest> req)
			throws ErrorInputException {
		CustomerRequest customerRequest = req.getTranrq();
		...
		// ObjectMapper：customerResponse -> entity
		ObjectMapper objectMapper = new ObjectMapper();
		objectMapper.convertValue(customerRequest, CustomerEntity.class);
